...
???+ quote "Der besondere Tipp von *Die Österreichisch Küche*.[^bitterman]"
    ...
    Das Herausbacken in Butterschmalz verleiht den Schnitzeln den ganz typischen
    leicht nussigen Geschamck. Werden die Schnitzerl in neutralem Pflanzeöl
    gebacken, so kann man dem Öl gegen Ende ein kleines Stück Butter zugeben und die
    Schnitzerl damit nochmals begießen oder Sie träufeln vor dem Servieren etwas
    zerlassene Butter direkt über die Schnitzel.
...
[^chefkoch]: Sonja.
    ...
    *Chef Koch.* 27 November 2000.

[^wagner]: Wagner, Renate.
