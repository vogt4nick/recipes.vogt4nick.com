...
=== "Zutaten"
    ...
    ??? quote "Gut zu Wissen von Florian Oberndorfer:[^oberndorfer_knödel]"
        ...
        Die Zwiebel sollten Sie immer fein schneiden und nicht hacken. Denn wenn
        gehackte Zwiebeln zu lange stehen, treten die Bitterstoffe hervor und das wirkt
        sich negativ auf den Geschmack der Knödel aus.

        Knödel lassen sich auch gut einfrieren---allerdings sollten Sie immer die rohen
        Knödel einfrieren, denn durch jeden weiteren Kochvorgang verlieren die Knödel an
        Geschmack. Auch die Konsistenz leidet beim erneuten Erhitzen im Wasserbad.
