...
??? question "What's the difference between the terms _leaven_ and _levain_?"
    ...
    _Leaven_ is an English word. It can be a noun meaning the same as above. It can also be used as a verb defining the action of fermentation. "I named my leaven Flint;" "I use Flint to leaven my bread dough."[^chainbaker]

[^chainbaker]:
    Charlie. ["Sourdough Starter and Leaven. Are They The Same Thing?"](https://www.chainbaker.com/starter-leaven/) _ChainBaker._  19 June 2022.
...
- Below 65% is a low hydration percentage. Low hydration doughs like [pain de mie](https://www.kingarthurbaking.com/recipes/pain-de-mie-recipe) are often tight, uniform crumb; ideal for sandwich loaves.
- 65-80% is a conventional hydration percentage range, common in standard artisan doughs like _The Perfect Loaf_'s [rustic country loaf](https://www.theperfectloaf.com/tartine-sourdough-country-loaf-bread-recipe/).
- Above 80% is a high hydration percentage. High hydration doughs like [ciabatta](https://www.chainbaker.com/extreme-ciabatta/) are often light, open crumb.
...
A **leaven** or **levain** is a prefermented mixture built from the starter for a single-use recipe. It often contains flour, water, and a small inoculation of mature starter. Leaven is mixed at specific hydration and allowed to ferment before being incorporated into the final mix.[^leo]
...
A **starter** or **mother culture** is the ongoing yeast colony you maintain. It provides the microbial population that drives fermentation in the leaven and dough.[^anastopoulo]
