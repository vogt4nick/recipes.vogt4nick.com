...
=== "Ingredients"
    ...
    ??? quote "To prepare the dumplings in advance:[^oberndorfer_knödel]"
        ...
        Always freeze the raw dumplings when preparing in advance, as the dumplings lose
        their flavor each time they are cooked. The consistency also suffers when they
        are reheated in a water bath.
